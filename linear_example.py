...
original = cv2.imread('/home/abu/Documents/learn/DL4CVStarterBundle-master/Chapter08/beagle.png')
...
cv2.putText(original, 'Label: {}'.format(labels[np.argmax(scores)]), (10, 300),
            cv2.FONT_HERSHEY_SIMPLEX, 1.9, (0, 255, 0), 2)
